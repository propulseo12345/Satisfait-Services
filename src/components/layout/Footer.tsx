          ...
          <div className="md:hidden space-y-8">
            ...
            <div className="text-center">
              <Link href="/" className="inline-flex items-center gap-2 mb-3">
                ...
                />
                <div>
                  <span className="text-lg font-bold text-white">Satisfait</span>
                  <span className="text-lg font-light text-primary-400"> Services</span>
                </div>
              </Link>
          ...
          <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
            ...
            <div className="lg:col-span-2">
              <Link href="/" className="inline-flex items-center gap-3 mb-4">
                ...
                />
                <div>
                  <span className="text-xl font-bold text-white">Satisfait</span>
                  <span className="text-xl font-light text-primary-400"> Services</span>
                </div>
              </Link>
              <p className="text-sm text-neutral-400 mb-5 max-w-md leading-relaxed">
                {SITE_CONFIG.slogan}. Services de ménage, nettoyage professionnel
                et home organising à Narcastet, Pau et dans les Pyrénées-Atlantiques.
              </p>
              <div className="space-y-2.5">
                ...
                <div className="flex items-center gap-2.5 text-sm text-neutral-400">
                  ...
                  <span>{SITE_CONFIG.address.city}, {SITE_CONFIG.address.postalCode}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm">
                <li className="flex justify-between text-neutral-400">
                  <span>Lun - Ven</span>
                  <span className="text-white">{SITE_CONFIG.hours.weekdays}</span>
                </li>
                <li className="flex justify-between text-neutral-400">
                  <span>Samedi</span>
                  <span className="text-white">{SITE_CONFIG.hours.saturday}</span>
                </li>
                <li className="flex justify-between text-neutral-400">
                  <span>Dimanche</span>
                  <span className="text-neutral-500">{SITE_CONFIG.hours.sunday}</span>
                </li>
              </ul>
            </div>
          </div>
