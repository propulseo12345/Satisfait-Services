        ...
        <div className="max-w-xl md:max-w-2xl">
          ...
          >
            ...
            <span className="block sm:inline">
              pour <span className="text-primary-400">votre intérieur</span>
            </span>
          </motion.h1>
          ...
          >
            <span className="hidden md:inline">
              Chez Satisfait Services, nous apportons des années d&apos;expertise
              dans les services à la personne, offrant des solutions durables,
              efficaces et abordables pour votre domicile.
            </span>
            <span className="md:hidden">
              Expertise et solutions durables pour votre domicile.
          ...
          >
            ...
            >
              ...
              <span className="md:hidden">Appeler maintenant</span>
              <span className="hidden md:inline">{SITE_CONFIG.contact.phone}</span>
            </a>
