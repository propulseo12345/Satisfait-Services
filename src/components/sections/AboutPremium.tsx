...
import { Heart, Shield, Award, Sparkles, Quote, ArrowRight, User } from "lucide-react";
            ...
            <div className="relative">
              ...
              >
                ...
                <p className="text-neutral-700 text-xs italic leading-relaxed">
                  &ldquo;Chaque foyer mérite un intérieur propre et serein.&rdquo;
                </p>
          ...
          >
            <div>
              ...
              <div className="space-y-3 text-neutral-600 text-sm md:text-base leading-relaxed">
                <p>
                  Passionnée par l&apos;organisation et le bien-être intérieur,
                  <strong className="text-neutral-900"> Tina</strong> a fondé
                  Satisfait Services avec une conviction : chaque foyer mérite
                  un espace propre et serein.
                </p>
                <p className="hidden md:block">
                  Basée à <strong className="text-neutral-900">Narcastet</strong>,
                  elle intervient dans toute la région paloise avec une approche
                  humaine et un sens aigu du détail.
                </p>
              </div>
            </div>
