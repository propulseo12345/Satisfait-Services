...
import { Container, SectionTitle, Card, CardContent, Button, InterventionMap } from "@/components/ui";
...
const serviceCategories = [
  {
    ...
    image: "/images/prestation-menage.jpg",
    description:
      "Un intérieur propre et accueillant au quotidien grâce à notre service de ménage régulier.",
    services: [
      "Ménage régulier et ponctuel",
      "Dépoussiérage complet",
      "Nettoyage des sols (aspiration, lavage)",
      "Entretien des surfaces (cuisine, salle de bain)",
  ...
  },
  {
    ...
    image: "/images/prestation-repassage.jpg",
    description:
      "Confiez-nous votre linge pour un repassage soigné et professionnel qui vous fait gagner un temps précieux.",
    services: [
      "Repassage de chemises et chemisiers",
      "Repassage du linge de maison",
      "Pliage et rangement",
  ...
  },
  {
    ...
    image: "/images/prestation-professionnel.jpg",
    description:
      "Des locaux professionnels propres et accueillants pour vos collaborateurs et clients.",
    services: [
  ...
  },
  {
    ...
    image: "/images/prestation-courses.jpg",
    description:
      "Des services pratiques pour vous simplifier la vie au quotidien.",
    services: [
      "Livraison de courses à domicile",
      "Aide aux courses pour personnes à mobilité réduite",
  ...
  },
  {
    ...
    image: "/images/prestation-nettoyage-specifique.jpg",
    description:
      "Des techniques professionnelles pour les travaux de nettoyage spécialisés.",
    services: [
      "Nettoyage de vitres intérieures et extérieures",
      "Shampouinage de moquettes",
      "Nettoyage de canapés en tissu",
      "Nettoyage de tapis et textiles",
  ...
  },
  {
    ...
    image: "/images/prestation-organising.jpg",
    description:
      "Un accompagnement personnalisé pour créer un intérieur fonctionnel qui vous ressemble.",
    services: [
      "Diagnostic et analyse de votre espace",
      "Accompagnement au désencombrement",
      "Organisation des rangements",
      "Coaching rangement personnalisé",
        ...
        <Container size="xl" className="px-2 sm:px-4 lg:px-6 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-neutral-600 leading-relaxed">
              Satisfait Services intervient à Narcastet, Pau et dans un rayon de
